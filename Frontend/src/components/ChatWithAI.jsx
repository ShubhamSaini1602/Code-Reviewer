        ...
        <div className={`thought-accordion ${isOpen ? 'open' : ''}`}>
            ...
            >
                <div className="thought-title-group">
                    {/* Icon with a subtle glow wrapper */}
                    <div className="icon-wrapper">
                        <i className="ri-shining-2-line thought-icon"></i>
                    </div>
                    <span className="thought-title-text">Show thinking</span>
                </div>
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const aiMessage = { 
                ...
                // Display both the thought process and the final answer in the chat
                    ...
                    <div key={index} className={`chat-bubble-wrapper ${msg.role === 'user' ? 'chat-right' : 'chat-left'}`}>
                        ...
                        <div className="chat-bubble">
                            ...
                            {msg.role === 'model' && msg.thought && (
                                <ThoughtProcess text={msg.thought} />
                            )}
